...
export function createMapboxStreetsV6Style() {
  var fill = new Style.Fill({color: ''});
  var stroke = new Style.Stroke({color: '', width: 1});
  var polygon = new Style.Style({fill: fill});
  var strokedPolygon = new Style.Style({fill: fill, stroke: stroke});
  var line = new Style.Style({stroke: stroke});
  var text = new Style.Style({text: new Style.Text({
